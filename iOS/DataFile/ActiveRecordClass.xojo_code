...
Inherits DataFile.ActiveRecordBase
	...
	#tag Method, Flags = &h0
		Shared Function List(sCriteria as Text = "", sOrder as Text = "", iOffset as Integer = -1) As DataFile.ActiveRecordClass()
		  // SQL Injection Note:
		  ...
		  dim arsSQL() as Text
		  dim sBase as Text = DataFile.ActiveRecordClass.BaseSQL
		  arsSQL.Append(sBase)
