#tag Class
Protected Class MSSQLServerAdapter
Inherits TP_ActiveRecord.DatabaseAdapter
	...
	#tag Method, Flags = &h0
		Sub Constructor(oDb as Object)
		  ...
		  // and do not have the MSSQLServerDatabase Plugin
		  // then you can safely delete this class
		  #if TP_ActiveRecord.kConfigUseMSSQLServer
		    Var db as MSSQLServerDatabase = MSSQLServerDatabase(oDb)
		    if db=nil then
	...
	#tag Method, Flags = &h0
		Sub InsertRecord(oRecord as TP_ActiveRecord.Base, byref dictSavedPropertyValue as Dictionary)
		  ...
		  var rs as RowSet = db.SelectSQL(sSQL, aroValues)
